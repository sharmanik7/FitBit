...
public class AddReminderActivity extends AppCompatActivity implements android.app.TimePickerDialog.OnTimeSetListener,
        DatePickerDialog.OnDateSetListener, LoaderManager.LoaderCallbacks<Cursor>, AddReminderActivityI {
    ...
    public void setTime(View v){
        DialogFragment timeFragement=new TimePickerFragement();
        timeFragement.show(getSupportFragmentManager(),"Time Picker");
    }
...
*/
        ...
        if (mCurrentReminderUri == null) {
            ...
            if (rowsAffected == 0)
                Toast.makeText(AddReminderActivity.this, "Error with updating reminder", Toast.LENGTH_LONG).show();
            else {
